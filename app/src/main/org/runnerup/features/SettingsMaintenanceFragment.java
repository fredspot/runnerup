...
public class SettingsMaintenanceFragment extends PreferenceFragmentCompat {
  ...
  private void updateAutomaticBackupStatus() {
    ...
    long lastBackup = org.runnerup.core.util.AutomaticBackupManager.getLastBackupTime(requireContext());
    int backupCount = org.runnerup.core.util.AutomaticBackupManager.getBackupCount(requireContext());
    List<org.runnerup.core.util.AutomaticBackupManager.BackupInfo> backups = 
        org.runnerup.core.util.AutomaticBackupManager.getBackups(requireContext());
  ...
  private void showRestoreBackupDialog() {
    ...
    for (int i = 0; i < backups.size(); i++) {
      org.runnerup.core.util.AutomaticBackupManager.BackupInfo info = backups.get(i);
    ...
    new AlertDialog.Builder(requireContext())
        ...
        .setItems(backupNames, (dialog, which) -> {
          org.runnerup.core.util.AutomaticBackupManager.BackupInfo selected = backups.get(which);
  ...
  private void confirmRestore(org.runnerup.core.util.AutomaticBackupManager.BackupInfo backup) {
    new AlertDialog.Builder(requireContext())
  ...
  private void performRestore(org.runnerup.core.util.AutomaticBackupManager.BackupInfo backup) {
    progressDialog = new ProgressDialog(requireContext());
  ...
  private void shareBackup(org.runnerup.core.util.AutomaticBackupManager.BackupInfo backup) {
    try {
