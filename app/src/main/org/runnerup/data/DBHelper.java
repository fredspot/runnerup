...
import org.runnerup.data.entities.DBEntity;
import org.runnerup.sync.DropboxSynchronizer;
import org.runnerup.sync.EndurainSynchronizer;
import org.runnerup.sync.FileSynchronizer;
import org.runnerup.sync.RunKeeperSynchronizer;
import org.runnerup.sync.RunalyzeSynchronizer;
import org.runnerup.sync.RunnerUpLiveSynchronizer;
import org.runnerup.sync.RunningAHEADSynchronizer;
import org.runnerup.sync.StravaSynchronizer;
import org.runnerup.sync.WebDavSynchronizer;
...
public class DBHelper extends SQLiteOpenHelper implements Constants {
  ...
  public static void importDatabase(Context ctx, String from) {
    ...
    try {
      ...
      boolean backupCreated = org.runnerup.core.util.AutomaticBackupManager.createBackup(ctx, true);
      if (backupCreated) {
